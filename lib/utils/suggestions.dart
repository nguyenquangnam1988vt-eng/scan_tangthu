/// Danh sách gợi ý tên thủ tục — 1 danh sách phẳng, không chia nhóm.
class ProcedureSuggestions {
  ...
  /// Bỏ dấu tiếng Việt để tìm không dấu vẫn ra.
  ...
  static List<String> search(String query) {
    ...
    return all.where((s) => normalize(s).contains(q)).toList();
  }
}
